...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/home/sbaykin/ffmpeg-vm/ffmpeg-3.4.2-tmp/ffmpeg_build --pkg-config-flags=--static --extra-cflags=-I/home/sbaykin/ffmpeg-vm/ffmpeg-3.4.2-tmp/ffmpeg_build/include --extra-ldflags=-L/home/sbaykin/ffmpeg-vm/ffmpeg-3.4.2-tmp/ffmpeg_build/lib --extra-libs='-lpthread -lm' --bindir=/home/sbaykin/ffmpeg-vm/ffmpeg-3.4.2-tmp/ffmpeg_build/bin --enable-gpl --enable-libx264 --enable-nonfree
prefix=/home/sbaykin/ffmpeg-vm/ffmpeg-3.4.2-tmp/ffmpeg_build
LIBDIR=$(DESTDIR)${prefix}/lib
SHLIBDIR=$(DESTDIR)${prefix}/lib
INCDIR=$(DESTDIR)${prefix}/include
BINDIR=$(DESTDIR)/home/sbaykin/ffmpeg-vm/ffmpeg-3.4.2-tmp/ffmpeg_build/bin
...
CC_IDENT=gcc 7 (Debian 7.3.0-19)
ARCH=x86
INTRINSICS=none
CC=gcc
CXX=g++
...
CFLAGS=  -I/home/sbaykin/ffmpeg-vm/ffmpeg-3.4.2-tmp/ffmpeg_build/include -std=c11 -fomit-frame-pointer -fPIC -pthread  -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=  -I/home/sbaykin/ffmpeg-vm/ffmpeg-3.4.2-tmp/ffmpeg_build/include -fPIC -g
...
DEPWINDRES=gcc
DOXYGEN=doxygen
LDFLAGS= -L/home/sbaykin/ffmpeg-vm/ffmpeg-3.4.2-tmp/ffmpeg_build/lib  -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDLIBFLAGS=
...
EXTRALIBS=-lx264 -lpthread -lm -ldl -lm -ldl -llzma -lbz2 -lz -pthread -pthread -lpthread -lm 
COMPAT_OBJS=
INSTALL=install
LIBTARGET=
